...
???
### --- early return: immediate feedback / skipping lengthier checks --- 
...
### -- foreshadowing future content/exercises --- ###
...
if(!("fpp3" %in% .packages())) return(c("You need to load the fpp3 package!" = TRUE))
## --- checking execution environment // sufficient and necessary ----
